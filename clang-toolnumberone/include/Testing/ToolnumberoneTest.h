...
/// @defgroup CHIMERA_TEST_TYPES Toolnumberone Test Types
/// \{
...
#define CHIMERA_MUTATOR_MATCH_TEST(mutator_class_name, mutator_identifier)     \
  TEST(mutator_identifier, mutator_test) {                                     \
    ::toolnumberone::testing::testMutatorMatch<mutator_class_name>();                \
  }
...
void testMutatorMatch ( toolnumberone::mutator::Mutator * );
...
} // End toolnumberone::test namespace
