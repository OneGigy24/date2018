...
bool toolnumberone::examples::MutatorGreaterOpReplacement::getMatchedNode(
...
toolnumberone::examples::MutatorGreaterOpReplacement::getStatementMatcher() {
...
bool toolnumberone::examples::MutatorGreaterOpReplacement::match(
    const ::toolnumberone::mutator::NodeType &node) {
...
::clang::Rewriter &toolnumberone::examples::MutatorGreaterOpReplacement::mutate(
    const ::toolnumberone::mutator::NodeType &node,
