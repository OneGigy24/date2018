...
toolnumberone::flapmutator::FLAPFloatOperationMutator::getStatementMatcher() {
...
static const BinaryOperator *getBop(const ::toolnumberone::mutator::NodeType &node) {
...
bool toolnumberone::flapmutator::FLAPFloatOperationMutator::match(
...
bool toolnumberone::flapmutator::FLAPFloatOperationMutator::getMatchedNode(
    const ::toolnumberone::mutator::NodeType &node,
...
::clang::Rewriter &toolnumberone::flapmutator::FLAPFloatOperationMutator::mutate(
    const ::toolnumberone::mutator::NodeType &node,
...
void toolnumberone::flapmutator::FLAPFloatOperationMutator::onCreatedMutant(
