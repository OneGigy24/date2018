...
bool toolnumberone::perforation::MutatorLoopPerforation2::getMatchedNode(
...
toolnumberone::perforation::MutatorLoopPerforation2::getStatementMatcher()
{
 return stmt(
...
bool toolnumberone::perforation::MutatorLoopPerforation2::match(
    const ::toolnumberone::mutator::NodeType &node)
{
...
::clang::Rewriter &toolnumberone::perforation::MutatorLoopPerforation2::mutate(
    const ::toolnumberone::mutator::NodeType &node,
...
void ::toolnumberone::perforation::MutatorLoopPerforation2::onCreatedMutant(
