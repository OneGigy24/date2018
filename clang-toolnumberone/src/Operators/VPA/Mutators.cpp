...
toolnumberone::vpamutator::VPAFloatOperationMutator::getStatementMatcher() {
...
bool toolnumberone::vpamutator::VPAFloatOperationMutator::match(
...
bool toolnumberone::vpamutator::VPAFloatOperationMutator::getMatchedNode(
    const ::toolnumberone::mutator::NodeType &node,
...
::clang::Rewriter &toolnumberone::vpamutator::VPAFloatOperationMutator::mutate(
    const ::toolnumberone::mutator::NodeType &node,
...
void toolnumberone::vpamutator::VPAFloatOperationMutator::onCreatedMutant(
