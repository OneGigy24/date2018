...
void toolnumberone::cd_utils::dump(
...
void toolnumberone::cd_utils::dump(std::ostream &out,
...
toolnumberone::cd_utils::CompileCommandVector
toolnumberone::cd_utils::getCompileCommandsByFilePath(
  ...
  ToolnumberoneLogger::verboseAndIncr("Retrieving compileCommands for " +
                                targetFilePath.str());
...
bool toolnumberone::cd_utils::changeCompileCommandTarget(
  ...
  for (auto commandLineElem = command.CommandLine.begin();
    ...
    if (::llvm::sys::path::filename(*commandLineElem) ==
      ...
      //::toolnumberone::log::ToolnumberoneLogger::verbose("Target found: " +
  ...
  // includes).
  command.CommandLine.push_back("-I" + ::toolnumberone::fs::getParentPath(oldTarget));
