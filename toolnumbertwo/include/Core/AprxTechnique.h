 ...
 ******************************************************************************/
#ifndef INCLUDE_TOOLNUMBERTWO_APRXTECHNIQUE_H_
#define INCLUDE_TOOLNUMBERTWO_APRXTECHNIQUE_H_
...
public:
  ...
  virtual ::std::vector<::std::string> applyApproximation (
      ::toolnumbertwo::core::AprxGrade ) const {
      return ::std::vector<::std::string>();
  }

  /// \brief Apply approximation using the addresses of variables
  virtual void applyApproximation ( ::toolnumbertwo::core::AprxGrade, ::std::vector<uint64_t> ) const =0;
...
#endif /* INCLUDE_TOOLNUMBERTWO_APRXTECHNIQUE_H_ */
