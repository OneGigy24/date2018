...
public:
  ...
  void setAprxLoc(const ::toolnumbertwo::core::AprxLocationVector &v){this->locations=v;}
...
private:
  ...
  /// \return user-defined error, provided by an TOOLNUMBERTWO _getError function
  ...
  ::toolnumbertwo::core::AprxLocationVector locations;
  ::toolnumbertwo::engine::ExecutionEngineHelper eeHelper;
...
public:
  ...
  void setAprxContext(const ::std::shared_ptr<::toolnumbertwo::core::AprxContext> C){ 
    this->aprxContext = C;
   }
...
private:  
  // Approximate Context
  ::std::shared_ptr<::toolnumbertwo::core::AprxContext> aprxContext;  
