...
//===----------------------------------------------------------------------===//
#ifndef INCLUDE_TOOLNUMBERTWO_LOOPAPRXTECHNIQUE_H_
#define INCLUDE_TOOLNUMBERTWO_LOOPAPRXTECHNIQUE_H_
...
class LoopAprxTechnique : public ::toolnumbertwo::core::AprxTechnique 
{
public:
  /// \brief Default ctor
