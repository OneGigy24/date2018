...
//===----------------------------------------------------------------------===//
#ifndef INCLUDE_TOOLNUMBERTWO_VPAAPRXTECHNIQUE_H_
#define INCLUDE_TOOLNUMBERTWO_VPAAPRXTECHNIQUE_H_
...
class VpaAprxTechnique : public ::toolnumbertwo::core::AprxTechnique 
{
public:
  // Default ctor
