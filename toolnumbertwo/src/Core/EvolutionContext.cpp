...
bool toolnumbertwo::core::EvolutionContext::initExecutionEngine(const ::std::string &cdPath) {
...
//TODO e sto tau
void toolnumbertwo::core::EvolutionContext::initializeEvolution
  (double tau, std::string param)
{
  // Compiling the Database 
  ::toolnumbertwo::log::ToolnumbertwoLogger::info(
    "Compiling the database ...\n");
...
void ::toolnumbertwo::core::EvolutionContext::printResult()
{
    // extract first front of the final population using an moeoArchive (this is the output of nsgaII)
    this->arch(pop);
    // printing of the final archive
    toolnumbertwo::log::ToolnumbertwoLogger::info("Final Archive");
    this->arch.sortedPrintOn (std::cout);
    ::std::cout << "\n";
    
    toolnumbertwo::log::ToolnumbertwoLogger::info("Acceptable solutions:");
...
double toolnumbertwo::core::aprxEval::getError(::toolnumbertwo::core::aprx &_aprx)
{
  ...
  if (this->eeHelper.runFunction(rv, "TOOLTWO_getError") != 0){
    toolnumbertwo::log::ToolnumbertwoLogger::error("Cannot launch TOOLTWO_getError. User must provide it!");
    exit(1);
  }
...
double toolnumbertwo::core::aprxEval::Reward(::toolnumbertwo::core::aprx &_aprx)
{
    if(!approximationApplied){
  ::std::vector<uint64_t> addrs;
  ...
  ::llvm::GenericValue rv;
  if (this->eeHelper.runFunction(rv, "TOOLTWO_Reward") != 0){
    return this->maximizingAprx(_aprx);
  }
  return rv.DoubleVal;
}

double toolnumbertwo::core::aprxEval::Penality(::toolnumbertwo::core::aprx &_aprx)
{
    if (this->eeHelper.checkFunction(::llvm::StringRef("TOOLTWO_Penality")) == 0) 
        return 0.0;
    if(!approximationApplied){
  ::std::vector<uint64_t> addrs;
 ...
 approximationApplied = true;
  ...
  ::llvm::GenericValue rv;
  if (this->eeHelper.runFunction(rv, "TOOLTWO_Penality") != 0){
    return 0;
  }
  return  rv.DoubleVal;
}

double toolnumbertwo::core::aprxEval::maximizingAprx(
        toolnumbertwo::core::aprx &_aprx)
{
  unsigned int sum = 0;
